/**
 * @file utils.cpp
 * @brief This code initializes an OpenGL rendering context, sets up a GLFW window, sets up the shaders and configures ImGui.
...
GLFWwindow* setupWindow(int width, int height)
{
    ...
    GLFWwindow* window = glfwCreateWindow(width, height, "Lab 1: Introduction to OpenGL Shaders", NULL, NULL);
    if (window == NULL)
        exit(0);
